...
let s:line = "282a2e"
let s:comment = "969896" "default
let s:red = "cc6666"
let s:orange = "de935f"
" let s:yellow = "f0c674"
let s:yellow = "FBA522"
let s:green = "b5bd68"
let s:green_s = "1D9431"
let s:bleu_s = "225CFB"
let s:aqua = "8abeb7"
let s:blue = "81a2be"
" let s:purple = "b294bb"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	" struct typedef
	call <SID>X("Structure", s:green_s, "", "")
	" #include
	call <SID>X("Include", s:bleu_s, "", "")
	" define
	call <SID>X("Define", s:orange, "", "none")
	" preproc
	call <SID>X("PreProc", s:pro_s, "", "")
